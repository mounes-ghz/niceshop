...
return [
    'manifest' => [
        'id' => 'pwa',
        'name' => env('APP_NAME', 'NiceShop'),
        'description' => 'Revolutionize your online business with the cutting-edge NiceShop e-commerce solution.',
        'short_name' => env('APP_NAME', 'NiceShop'),
        'dir' => 'auto',
        'lang' => 'fa',
        'scope' => '/',
        'start_url' => '/',
