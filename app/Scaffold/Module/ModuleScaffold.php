...
namespace NiceShop\Scaffold\Module;

use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Facades\Artisan;
use NiceShop\Scaffold\Module\Generators\FilesGenerator;
...
class ModuleScaffold
{
    ...
    private function modifyComposerJsonFile(): void
    {
        ...
        foreach ($composerJsonFileAsArray as $lineNumber => $textLine) {
            if ($lineNumber === 2) {
                $composerJsonText .= "    \"description\": \"The NiceShop {$moduleName} Module.\"," . PHP_EOL;
                continue;
...
JSON;
        ...
        $replace = <<<JSON
"description": "The NiceShop {$moduleName} Module.",
JSON;
