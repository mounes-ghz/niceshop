...
$(function () {
    ...
    var o = $.NiceShop.options;

    // Set up the object
    _init();

    // Activate layout
    $.NiceShop.layout.activate();

    // Enable sidebar tree view controls
    if (o.enableControlTreeView) {
        $.NiceShop.tree(".sidebar");
    }

    // Activate sidebar push menu
    if (o.sidebarPushMenu) {
        $.NiceShop.pushMenu.activate(o.sidebarToggleSelector);
    }
...
/* ----------------------------------
   - Initialize the NiceShop Object -
   ---------------------------------- */
function _init() {
    // Layout
    $.NiceShop.layout = {
    ...
    $.NiceShop.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.NiceShop.options.screenSizes;
    ...
    // Tree
    $.NiceShop.tree = function (menu) {
        var animationSpeed = $.NiceShop.options.animationSpeed;
