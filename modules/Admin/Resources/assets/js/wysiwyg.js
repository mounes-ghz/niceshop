...
export default function (options = {}) {
    tinymce.baseURL = `${NiceShop.baseUrl}/build/assets/tinymce`;
    ...
    tinymce.init({
        ...
        directionality: NiceShop.rtl ? "rtl" : "ltr",
        cache_suffix: `?v=${NiceShop.version}`,
        content_style: "body { color: #333333; }",
        plugins:
            "lists, link, table, image, media, paste, autosave, autolink, wordcount, code, fullscreen",
        toolbar:
