...
NiceShop.dataTable = { routes: {}, selected: {} };
...
export default class {
    constructor(selector, options, callback) {
        ...
        if (NiceShop.dataTable.selected[selector] === undefined) {
            NiceShop.dataTable.selected[selector] = [];
        }
    ...
    appendToSelected(id) {
        ...
        if (!NiceShop.dataTable.selected[this.selector].includes(id)) {
            NiceShop.dataTable.selected[this.selector].push(id);
        }
    }
    ...
    removeFromSelected(id) {
        ...
        NiceShop.dataTable.selected[this.selector].remove(id);
    }
    ...
    route(name, params) {
        let router = NiceShop.dataTable.routes[this.selector][name];
    ...
    hasRoute(name) {
        return NiceShop.dataTable.routes[this.selector][name] !== undefined;
    }

    static setRoutes(selector, routes) {
        NiceShop.dataTable.routes[selector] = routes;
    }

    static setSelectedIds(selector, selected) {
        NiceShop.dataTable.selected[selector] = selected;
    }

    static getSelectedIds(selector) {
        return NiceShop.dataTable.selected[selector];
    }
