...
@push('globals')
    <script>
        NiceShop.data['product'] = {!! $product_resource !!};
        NiceShop.data['attribute-sets'] = @json($attributeSets);
        NiceShop.langs['product::products.section.order_saved'] = '{{ trans('product::products.section.order_saved') }}';
        NiceShop.langs['product::products.variants.variants'] = '{{ trans('product::products.variants.variants') }}';
        NiceShop.langs['product::products.variants.variant'] = '{{ trans('product::products.variants.variant') }}';
        NiceShop.langs['product::products.variants.bulk_variants_updated'] = '{{ trans('product::products.variants.bulk_variants_updated') }}';
        NiceShop.langs['product::products.variants.variants_created'] = '{{ trans('product::products.variants.variants_created') }}';
        NiceShop.langs['product::products.variants.variants_removed'] = '{{ trans('product::products.variants.variants_removed') }}';
        NiceShop.langs['product::products.variants.variants_reordered'] = '{{ trans('product::products.variants.variants_reordered') }}';
        NiceShop.langs['product::products.variants.disable_default_variant'] = '{{ trans('product::products.variants.disable_default_variant') }}';
        NiceShop.langs['product::products.options.option_inserted'] = '{{ trans('product::products.options.option_inserted') }}';
    </script>
