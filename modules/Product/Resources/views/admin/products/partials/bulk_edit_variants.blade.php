<div class="bulk-edit-variants overflow-hidden">
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <select name="variation_values_list" id="variation-values-list" class="form-control custom-select-black" @change="changeBulkEditVariantsUid($event.target.value)" v-model="bulkEditVariantsUid">
    ...
    <div v-if="hasBulkEditVariantsUid" class="form-group">
        ...
        <div class="col-sm-5">
            <select name="bulk_edit_variants_field_type" id="bulk-edit-variants-field-type" class="form-control custom-select-black" @change="changeBulkEditVariantsField($event.target.value)" v-model="bulkEditVariantsField">
                <option value="">{{ trans('admin::admin.form.please_select') }}</option>
    ...
    <template v-if="hasBulkEditVariantsUid && hasBulkEditVariantsField">
        <div v-if="bulkEditVariantsField === 'is_active'" class="form-group">
            ...
            <div class="col-sm-5">
                <div class="checkbox">
                    <input type="checkbox" name="bulk_edit_variants_is_active" id="bulk-edit-variants-is-active" v-model="bulkEditVariants.is_active">
        ...
        <div v-else-if="bulkEditVariantsField === 'media'" class="form-group">
            ...
            <div class="col-sm-5">
                <draggable animation="200" class="product-media-grid" force-fallback="true" handle=".handle" :move="preventLastSlideDrag" :list="bulkEditVariants.media">
        ...
        <div v-else-if="bulkEditVariantsField === 'sku'" class="form-group">
            ...
            <div class="col-sm-5">
                <input type="text" name="bulk_edit_variants_sku" id="bulk-edit-variants-sku" class="form-control" v-model="bulkEditVariants.sku">
            </div>
        </div>
        ...
        <div v-else-if="bulkEditVariantsField === 'price'" class="form-group">
            ...
            <div class="col-sm-5">
                <div class="input-group">
                    ...
                    <input type="number" name="bulk_edit_variants_price" min="0" step="0.1" id="bulk-edit-variants-price" class="form-control" @wheel="$event.target.blur()" v-model.number="bulkEditVariants.price">
                </div>
            </div>
        </div>
        ...
        <template v-else-if="bulkEditVariantsField === 'special_price'">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="input-group">
                        ...
                        <input type="number" name="bulk_edit_variants_special_price" min="0" step="0.1" id="bulk-edit-variants-special-price" class="form-control" @wheel="$event.target.blur()" v-model="bulkEditVariants.special_price">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="bulk_edit_variants_special_price_type" id="bulk-edit-variants-special-price-type" class="form-control custom-select-black" v-model="bulkEditVariants.special_price_type">
                        <option value="fixed">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    @if (locale() == 'fa')
                        <date-picker id="bulk-edit-variants-special-price-start" input-class="form-control" v-model="bulkEditVariants.special_price_start" :clearable="true" format="YYYY-MM-DD HH:mm" display-format="jDD jMMMM jYYYY, HH:mm" :input-attrs="{ readonly: 'readonly' }" type="datetime" append-to="body" />
                    @else
                        <flat-pickr name="bulk_edit_variants_special_price_start" id="bulk-edit-variants-special-price-start" class="form-control" :config="flatPickrConfig" v-model="bulkEditVariants.special_price_start">
                        </flat-pickr>
                    @endif
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    @if (locale() == 'fa')
                        <date-picker id="bulk-edit-variants-special-price-end" input-class="form-control" v-model="bulkEditVariants.special_price_end" :clearable="true" format="YYYY-MM-DD HH:mm" display-format="jDD jMMMM jYYYY, HH:mm" :input-attrs="{ readonly: 'readonly' }" type="datetime" append-to="body" />
                    @else
                        <flat-pickr name="bulk_edit_variants_special_price_end" id="bulk-edit-variants-special-price-end" class="form-control" :config="flatPickrConfig" v-model="bulkEditVariants.special_price_end">
                        </flat-pickr>
                    @endif
                </div>
            </div>
        ...
        <template v-else-if="bulkEditVariantsField === 'manage_stock'">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <select name="bulk_edit_variants_manage_stock`" id="bulk-edit-variants-manage-stock" class="form-control custom-select-black" @change="focusField({
            ...
            <div v-if="bulkEditVariants.manage_stock == 1" class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="number" name="bulk_edit_variants_qty" min="0" step="1" id="bulk-edit-variants-qty" class="form-control" @wheel="$event.target.blur()" v-model.number="bulkEditVariants.qty">
                </div>
            </div>
        </template>
        ...
        <div v-else-if="bulkEditVariantsField === 'in_stock'" class="form-group">
            ...
            <div class="col-sm-5">
                <select name="bulk_edit_variants_in_stock`" id="bulk-edit-variants-in-stock`" class="form-control custom-select-black" v-model="bulkEditVariants.in_stock">
                    <option value="0">
