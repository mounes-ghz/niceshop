    ...
    <div class="box-body">
        ...
        <template v-else>
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group price-input-group">
                        ...
                        <input type="number" min="0" name="price" step="0.1" id="price" class="form-control" @wheel="$event.target.blur()" v-model="form.price">
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group price-input-group">
                        ...
                        <input type="number" min="0" name="special_price" step="0.1" id="special-price" class="form-control" @wheel="$event.target.blur()" v-model="form.special_price">
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select name="special_price_type" id="special-price-type" class="form-control custom-select-black" v-model="form.special_price_type">
                        <option value="fixed">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        ...
                        @if (locale() == 'fa')
                            <date-picker v-model="form.special_price_start" :clearable="true" format="YYYY-MM-DD HH:mm" display-format="jDD jMMMM jYYYY, HH:mm" :input-attrs="{ readonly: 'readonly' }" type="datetime" append-to="body" />
                        @else
                            <flat-pickr name="special_price_start" id="special-price-start" class="form-control" :config="flatPickrConfig" v-model="form.special_price_start">
                            </flat-pickr>

                            <span class="input-group-addon cursor-pointer" v-if="form.special_price_start" @click="removeDatePickerValue('special_price_start')">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="input-group">
                        ...
                        @if (locale() == 'fa')
                            <date-picker v-model="form.special_price_end" :clearable="true" format="YYYY-MM-DD HH:mm" display-format="jDD jMMMM jYYYY, HH:mm" :input-attrs="{ readonly: 'readonly' }" type="datetime" append-to="body" />
                        @else
                            <flat-pickr name="special_price_end" id="special-price-end" class="form-control" :config="flatPickrConfig" v-model="form.special_price_end">
                            </flat-pickr>

                            <span class="input-group-addon cursor-pointer" v-if="form.special_price_end" @click="removeDatePickerValue('special_price_end')">
                                <i class="fa fa-times" aria-hidden="true"></i>
                            </span>
                        @endif
                    </div>
