        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="input-group">
                    ...
                    @if (locale() == 'fa')
                        <date-picker input-class="form-control" v-model="form.new_from" :clearable="true" format="YYYY-MM-DD HH:mm" display-format="jDD jMMMM jYYYY, HH:mm" :input-attrs="{ readonly: 'readonly' }" type="datetime" append-to="body" />
                    @else
                        <flat-pickr name="new_from" id="new-from" class="form-control" :config="flatPickrConfig" v-model="form.new_from">
                        </flat-pickr>

                        <span class="input-group-addon cursor-pointer" v-if="form.new_from" @click="removeDatePickerValue('new_from')">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="input-group">
                    ...
                    @if (locale() == 'fa')
                        <date-picker v-model="form.new_to" auto-submit format="YYYY-MM-DD HH:mm" :clearable="true" display-format="jDD jMMMM jYYYY, HH:mm" :input-attrs="{ readonly: 'readonly' }" type="datetime" append-to="body" />
                    @else
                        <flat-pickr name="new_to" id="new-to" class="form-control" :config="flatPickrConfig" v-model="form.new_to">
                        </flat-pickr>

                        <span class="input-group-addon cursor-pointer" v-if="form.new_to" @click="removeDatePickerValue('new_to')">
                            <i class="fa fa-times" aria-hidden="true"></i>
                        </span>
                    @endif
                </div>
