...
return [
    ...
    'ippanel_new_order_admin_sms_pattern' => 'New order Admin pattern',
    'ippanel_welcome_sms_pattern' => 'Weclome sms pattern',
    'ippanel_new_order_sms_pattern' => 'New order pattern',
    'ippanel_sms_order_statuses_pattern' => 'Order status pattern',
    'kavenegar_api_key' => 'Api key',
    'kavenegar_new_order_admin_sms_pattern' => 'New order Admin pattern',
    'kavenegar_welcome_sms_pattern' => 'Weclome sms pattern',
    'kavenegar_new_order_sms_pattern' => 'New order pattern',
    'kavenegar_sms_order_statuses_pattern' => 'Order status pattern',
    'melipayamak_username' => 'Username',
    'melipayamak_password' => 'Password',
    'melipayamak_new_order_admin_sms_pattern' => 'New order Admin pattern',
    'melipayamak_welcome_sms_pattern' => 'Weclome sms pattern',
    'melipayamak_new_order_sms_pattern' => 'New order pattern',
    'melipayamak_sms_order_statuses_pattern' => 'Order status pattern',
    ...
    'flat_rate_cost' => 'Cost',
    'payir_enabled' => 'Status',
    'translatable.payir_gateway_label' => 'Label',
    'translatable.payir_gateway_description' => 'Description',
    'payir_merchantId' => 'MerchantId',

    'zarinpal_enabled' => 'Status',
    'translatable.zarinpal_gateway_label' => 'Label',
    'translatable.zarinpal_gateway_description' => 'Description',
    'zarinpal_merchantId' => 'MerchantId',

    'zibal_enabled' => 'Status',
    'translatable.zibal_gateway_label' => 'Label',
    'translatable.zibal_gateway_description' => 'Description',
    'zibal_merchantId' => 'MerchantId',

    'sadad_enabled' => 'Status',
    'translatable.sadad_gateway_label' => 'Label',
    'translatable.sadad_gateway_description' => 'Description',
    'sadad_key' => 'Key',
    'sadad_merchantId' => 'MerchantId',
    'sadad_terminalId' => 'TerminalId',

    'saman_enabled' => 'Status',
    'translatable.saman_gateway_label' => 'Label',
    'translatable.saman_gateway_description' => 'Description',
    'saman_merchantId' => 'MerchantId',

    'sepehr_enabled' => 'Status',
    'translatable.sepehr_gateway_label' => 'Label',
    'translatable.sepehr_gateway_description' => 'Description',
    'sepehr_terminalId' => 'TerminalId',

    'idpay_enabled' => 'Status',
    'translatable.idpay_gateway_label' => 'Label',
    'translatable.idpay_gateway_description' => 'Description',
    'idpay_merchantId' => 'MerchantId',

    'irankish_enabled' => 'Status',
    'translatable.irankish_gateway_label' => 'Label',
    'translatable.irankish_gateway_description' => 'Description',
    'irankish_terminalId' => 'TerminalId',
    'irankish_password' => 'Password',
    'irankish_acceptorId' => 'AcceptorId',
    'irankish_pubKey' => 'Public Key',

    'payping_enabled' => 'Status',
    'translatable.payping_gateway_label' => 'Label',
    'translatable.payping_gateway_description' => 'Description',
    'payping_merchantId' => 'MerchantId',

    'behpardakht_enabled' => 'Status',
    'translatable.behpardakht_gateway_label' => 'Label',
    'translatable.behpardakht_gateway_description' => 'Description',
    'behpardakht_terminalId' => 'terminalId',
    'behpardakht_username' => 'username',
    'behpardakht_password' => 'password',
