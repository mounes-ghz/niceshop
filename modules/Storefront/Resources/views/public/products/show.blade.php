...
@push('globals')
    <script>
        NiceShop.langs['storefront::product.in_stock'] = '{{ trans('storefront::product.in_stock') }}';
        NiceShop.langs['storefront::product.left_in_stock'] = '{{ trans('storefront::product.left_in_stock') }}';
        NiceShop.langs['storefront::product.add_to_cart'] = '{{ trans('storefront::product.add_to_cart') }}';
        NiceShop.langs['storefront::product.unavailable'] = '{{ trans('storefront::product.unavailable') }}';
        NiceShop.langs['storefront::product.reviews'] = '{{ trans("storefront::product.reviews") }}';
        NiceShop.langs['storefront::product.review_submitted'] = '{{ trans("storefront::product.review_submitted") }}';
        NiceShop.langs['storefront::product.related_products'] = '{{ trans("storefront::product.related_products") }}';
    </script>
