        ...
        <section class="checkout-wrap">
            <div class="container">
                <template v-if="cartIsNotEmpty">
                    ...
                    <form ref="shetabitForm" id="shetabitForm" class="d-none" method="get" :action="shetabitData.action" >
                        <input v-for="(input, name, index) in shetabitData.inputs" :key="index" type="hidden" :name="name" :value="input" />
                        <button type="submit"></button>
                    </form>
