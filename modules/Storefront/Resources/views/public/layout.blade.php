...
<head>
    ...
    <link href="{{ font_url(setting('storefront_display_font', 'Inter')) }}" rel="stylesheet">

    <style>
        :root {
            --base-font-family: "{{ setting('storefront_display_font', 'Inter') }}", sans-serif;
            --font-light: 300;
            --font-normal: 400;
            --font-medium: 500;
        }
    ...
    @if (is_rtl())
        @vite(['modules/Storefront/Resources/assets/public/sass/custom.scss'])
    @endif
    ...
    <script type="text/javascript">
        !function(){var i="Vsf8hM",a=window,d=document;function g(){var g=d.createElement("script"),s="https://www.goftino.com/widget/"+i,l=localStorage.getItem("goftino_"+i);g.async=!0,g.src=l?s+"?o="+l:s;d.getElementsByTagName("head")[0].appendChild(g);}"complete"===d.readyState?g():a.attachEvent?a.attachEvent("onload",g):a.addEventListener("load",g,!1);}();
    </script>
