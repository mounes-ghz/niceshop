...
export default {
    ...
    methods: {
                ...
                .then(({ data }) => {
                    if (data.redirectUrl) {
                        ...
                        [
                            ...
                            "payping",
                            "behpardakht",
                        ].includes(this.form.payment_method)
                    ) {
                        this.confirmShetabitPayment(data);
        ...
        confirmShetabitPayment(data) {
            this.shetabitData = data;

            this.$nextTick(() => {
                this.$refs.shetabitForm.submit();
        ...
        confirmFlutterWavePayment({
            ...
            FlutterwaveCheckout({
                ...
                customizations: {
                    title: NiceShop.storeName,
                    logo: NiceShop.storeLogo,
                },
                onclose(incomplete) {
                    vm.placingOrder = false;
