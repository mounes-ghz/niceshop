...
export default {
    ...
    computed: {
        ...
        fromPriceFormatted() {
            return Number(this.queryParams.fromPrice).toLocaleString();
        },
        toPriceFormatted() {
            return Number(this.queryParams.toPrice).toLocaleString();
        },
    },
    ...
    methods: {
        ...
        initPriceFilter() {
            noUiSlider.create(this.$refs.priceRange, {
                connect: true,
                direction: window.NiceShop.rtl ? "rtl" : "ltr",
